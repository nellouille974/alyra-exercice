...
// Afficher les dix dernieres images ( provoque une erreur )

// async function recupAllImg() {
// 	let all = await collectionCard.toutRecuperer();
// 	node.cat(all, function (err,file) {
// 		let list = document.getElementById("list");
// 		for(let i = 0;i < all.length && i < 10; i++){
// 			list = '<img src="data:image/jpg;base64,"' + file.toString('base64') + '"/>';
// 		}
// 	})
// }
